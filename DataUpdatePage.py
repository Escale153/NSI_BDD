...
class DataUpdatePage(tk.Frame):
    ...
    def __init__(self, parent, show_frame, datamanager):
        ...
        self.status_label_add = tk.Label(self, text="", fg="green", bg="#F4FEFE", font=self.used_font)
        self.status_label_add.place(x=padding_x, y=y_start + 160)
        ...
        tk.Label(self, text="Sélectionner une colonne :", font=("Arial", 12), bg="#F4FEFE",fg="#002147").place(x=padding_x, y=y_start_update + 120)
        ...
        self.column_dropdown_update.place(x=padding_x, y=y_start_update + 150)

        self.choose_column_button_update = ttk.Button(self, text="Choisir la colonne", command=self.display_column_values_update, style="TButton")
        self.choose_column_button_update.place(x=padding_x, y=y_start_update + 190)

        tk.Label(self, text="Valeurs de la colonne :", font=("Arial", 12), bg="#F4FEFE",fg="#002147").place(x=padding_x, y=y_start_update + 290)
        ...
        self.value_dropdown_update.place(x=padding_x, y=y_start_update + 280)

        tk.Label(self, text="Entrez la valeur à remplacer :", font=("Arial", 12), bg="#F4FEFE",fg="#002147").place(x=padding_x + 220, y=y_start_update + 260)
        self.replace_data_entry = ttk.Entry(self, style="Rounded.TEntry", width=25)
        self.replace_data_entry.place(x=padding_x + 220, y=y_start_update + 280)

        self.button_update = ttk.Button(self, text="Remplacer par cette valeur", command=self.update_data, style="TButton")
        self.button_update.place(x=padding_x + 220, y=y_start_update + 330)

        self.status_label_update = tk.Label(self, text="", fg="green", bg="#F4FEFE", font=self.used_font)
        self.status_label_update.place(x=padding_x, y=y_start_update + 380)
        ...
        self.choose_table_button_delete = ttk.Button(self, text="Choisir la table", command=self.load_columns_delete, style="TButton")
        self.choose_table_button_delete.place(x=x_start_delete, y=y_start_delete + 70)

        tk.Label(self, text="Sélectionner une colonne :", font=("Arial", 12), bg="#F4FEFE").place(x=x_start_delete, y=y_start_delete + 120)
        ...
        self.column_dropdown_delete.place(x=x_start_delete, y=y_start_delete + 150)

        self.choose_column_button_delete = ttk.Button(self, text="Choisir la colonne", command=self.display_column_values_delete, style="TButton")
        self.choose_column_button_delete.place(x=x_start_delete, y=y_start_delete + 190)

        tk.Label(self, text="Valeurs de la colonne :", font=("Arial", 12), bg="#F4FEFE").place(x=x_start_delete, y=y_start_delete + 250)
        ...
        self.value_dropdown_delete.place(x=x_start_delete, y=y_start_delete + 280)

        self.button_delete = ttk.Button(self, text="Supprimer cette valeur", command=self.delete_data, style="TButton")
        self.button_delete.place(x=x_start_delete, y=y_start_delete + 330)

        self.status_label_delete = tk.Label(self, text="", fg="green", font=self.used_font, bg="#F4FEFE")
        self.status_label_delete.place(x=x_start_delete, y=y_start_delete + 380)

        # Bouton Retour
        self.back_button = ttk.Button(self, text="Retour", command=lambda: self.show_frame("MainMenuPage"), style="TButton")
        self.back_button.place(x=600, y=650)  # Positionné au bas de la fenêtre
    ...
    def add_values(self):
        ...
        try: #on verifie que l action est possible : Contraintes + nbr de valeurs a ajouter
            ...
            self.status_label_add.config(text=f"Un problème est survenu avec le format des données \n {sqe}", fg="red")
            return None

        except ValueError as dme: #erreur de domaines
            self.status_label_add.config(text=f"Un problème est survenu avec les valeurs \n {dme}", fg="red")
            return None

        #label en vert soit la reussite de l action (idem pour les autres), les valeurs sont ajoutees
        self.status_label_add.config(text=f"Ajout réussi à la table '{table_name}' : {values_list}", fg="green")
    ...
    def update_data(self):
        ...
        try: #on verifie les eventuelles contraintes : domaines surtout
            ...
            self.status_label_update.config(text=f"Un problème est survenu avec la saisi : {dme}", fg="red")
            return None

        except sqlite3.OperationalError as sqe: #autre erreur potentielle de sqlite
            self.status_label_update.config(text=f"Un problème est survenu avec la saisi : {sqe}", fg="red")
            return None

        self.status_label_update.config(text="Les modifications ont été prises en compte", fg="green")
    ...
    def delete_data(self):
        ...
        try: #on verifie si il n y a pas d erreur venant de sqlite
            ...
            self.status_label_delete.config(text="Un problème est survenu", fg="red")
            return None

        self.status_label_delete.config(text=f"La donnée : {selected_value} a bien été supprimée", fg="green")
        self.load_and_update_tables()

    def load_columns_update(self):
        """
    ...
    def display_column_values_update(self):
        """
    ...
    def display_column_values_delete(self):
        """
