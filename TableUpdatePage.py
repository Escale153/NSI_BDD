...
class TableUpdatePage(tk.Frame):
    ...
    def __init__(self, parent, show_frame, datamanager):
        ...
        self.table_dropdown_delete.bind("<<ComboboxSelected>>", self.load_column_erase)
        #envoie direcetment les colonnes dans le menu deroulant apres avoir selectionne la table
        ...
        self.column_dropdown_delete.place(x=500, y=430)

        self.erase_column_button = ttk.Button(self, text="Supprimer", command=self.erase_column, style="TButton")
        self.erase_column_button.place(x=500, y=470)

        # Renommer une colonne
        tk.Label(self, text="Renommer une colonne :", font=self.used_font, bg="#F4FEFE").place(x=950, y=180)
        ...
        self.table_dropdown_renamecol.bind("<<ComboboxSelected>>", self.load_column_rename)
        ...
        self.column_dropdown_renamecol.place(x=950, y=250)

        tk.Label(self, text="Nouveau nom:", font=self.used_font, bg="#F4FEFE").place(x=950, y=290)
        self.columnrename_entry = ttk.Entry(self, width=22, style="Rounded.TEntry")
        self.columnrename_entry.place(x=950, y=320)

        self.rename_column_button = ttk.Button(self, text="Renommer", command=self.rename_column, style="TButton")
        self.rename_column_button.place(x=950, y=360)
    ...
    def load_column_erase(self, event=""):
        """
        cf DataUpdatePage
        :return:
        """
    ...
    def load_column_rename(self, event=""):
        """
        Cf DataUpdatePage
        :return:
        """
