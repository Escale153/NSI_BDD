...
class TableUpdatePage(tk.Frame):
    ...
    def __init__(self, parent, show_frame, datamanager):
        ...
        self.status_label_table = tk.Label(self, text="", fg="green", font=self.used_font, bg="#F4FEFE")
        self.status_label_table.place(x=padding_x, y=y_start + 338)
        ...
        self.status_label_erase = tk.Label(self, text="", fg="green", font=self.used_font, bg="#F4FEFE")
        self.status_label_erase.place(x=padding_x, y=y_start + 475)
        ...
        self.status_label_rename = tk.Label(self, text="", fg="green", font=self.used_font, bg="#F4FEFE")
        self.status_label_rename.place(x=padding_x, y=y_start + 650)
        ...
        self.status_label_addcolumn = tk.Label(self, text="", fg="green", font=self.used_font, bg="#F4FEFE")
        self.status_label_addcolumn.place(x=500, y=120)
        ...
        self.status_label_erasecolumn = tk.Label(self, text="", fg="green", font=self.used_font, bg="#F4FEFE")
        self.status_label_erasecolumn.place(x=500, y=560)
        ...
        self.status_label_renamecolumn = tk.Label(self, text="", fg="green", font=self.used_font, bg="#F4FEFE")
        self.status_label_renamecolumn.place(x=800, y=460)
    ...
    def add_table(self):
        ...
        try: #avec try/except on evite certaines erreurs
            ...
            self.status_label_table.config(text=f"Un problème est survenu dans la saisi des colonnes : {e}", fg="red")
            return None
        self.status_label_table.config(text=f"La table '{table_name}' a été créée avec succès.", fg="green")
        self.load_and_update_tables()
    ...
    def erase_table(self):
        ...
        try: #evite les erreurs dues a sqlite
            self.datamanager.drop_table(table_name) #supprime la table
                ...
                self.status_label_erase.config(text="Un problème est survenu", fg="red")
                return None
        self.status_label_erase.config(text=f"La table '{table_name}' a été supprimée avec succès.", fg="green")
        self.load_and_update_tables()
    ...
    def rename_table(self):
        ...
        try: #evite les erreurs
            self.datamanager.rename_table(selected_table, new_name)
                ...
                self.status_label_rename.config(text="Un problème est survenu", fg="red")
                return None
        self.status_label_rename.config(text=f"La table {selected_table} est désormais titrée comme {new_name}", fg="green")
        self.load_and_update_tables()
    ...
    def add_column(self):
        ...
        try: #idem
            ...
            self.status_label_addcolumn.config(text="Le format de la saisie est incorrect", fg="red")
            return None
        self.status_label_addcolumn.config(text=f"La colonne {name} a bien été rajoutée à la table {selected_table}", fg="green")
        self.load_and_update_tables()
    ...
    def erase_column(self):
        ...
        try: #toujours pareil
            ...
            self.status_label_erasecolumn.config(text="Un problème est survenu", fg="red")
            return None
        self.status_label_erasecolumn.config(text=f"La colonne {selected_column} a été supprimée de la table {selected_table}", fg="green")
        self.load_and_update_tables()
    ...
    def rename_column(self):
        ...
        try: #iiiiiiiiiidem
            ...
            self.status_label_renamecolumn.config(text="Un problème est survenu", fg="red")
            return None
        self.status_label_renamecolumn.config(text=f"La colonne {selected_column} est désormais titrée comme {new_name}", fg="green")
        self.load_and_update_tables()
